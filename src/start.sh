...
echo "change commands: /var/www"
sudo chmod -R 775 "/var/www"
echo "change commands: START_SH_FILE"
sudo chmod 777 "$START_SH_FILE"
echo "change commands: UPDATE_SH_FILE"
sudo chmod 777 "$UPDATE_SH_FILE"
echo "change commands: DATA_JSON_TEMP"
sudo chmod 777 "$DATA_JSON_TEMP"
echo "change commands: DATA_JSON_SRC"
